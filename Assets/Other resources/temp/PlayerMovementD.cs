...
public class PlayerMovementD : MonoBehaviour
{
    ...
    private void Look()
    {
        transform.Rotate(Vector3.up * Input.GetAxisRaw("Mouse X") * 0.8f);
        verticalLookRotation += Input.GetAxisRaw("Mouse Y") * 0.8f;
        verticalLookRotation = Mathf.Clamp(verticalLookRotation, -90f, 90f);
        playerView.transform.localEulerAngles = Vector3.left * verticalLookRotation;
    }
